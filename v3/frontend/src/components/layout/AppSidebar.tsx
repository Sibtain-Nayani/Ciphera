    ...
    return (
        ...
        >
            ...
            <nav className="flex-1 p-4 flex flex-col gap-2">
                ...
                >
                    <LayoutDashboard className={`w-5 h-5 shrink-0 transition-transform ${pathname === "/dashboard" ? "scale-110" : "opacity-80"}`} />
                ...
                >
                    <ShieldCheck className={`w-5 h-5 shrink-0 transition-transform ${pathname === "/redact" ? "scale-110" : "opacity-80"}`} />
                ...
                >
                    <Settings className={`w-5 h-5 shrink-0 transition-transform ${pathname === "/settings" ? "scale-110" : "opacity-80"}`} />
