 ...
 * Saves them, sets auth cookie, redirects to dashboard.
...
export default function AuthCallbackPage() {
    ...
    useEffect(() => {
        ...
        // Clear the fragment from URL (security — don't leave tokens in history)
            ...
            {error ? (
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "12px" }}>
                    ...
                    <button onClick={() => router.replace("/login")}
                        style={{ background: "#F5C400", color: "#080808", border: "none", padding: "10px 24px", fontFamily: "Courier New, monospace", fontSize: "9px", letterSpacing: "0.18em", textTransform: "uppercase", fontWeight: 700, cursor: "pointer" }}>
                        Back to Login
                    </button>
                </div>
            ) : (
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "10px" }}>
                    ...
                    <span style={{ fontFamily: "Courier New, monospace", fontSize: "9px", letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(239,239,239,0.4)" }}>
                        Authenticating…
                    </span>
                </div>
            )}
